function [weight, rms] = polynomialRegression(input, output, calculated_weight, degree)
%polynomialRegression implements the closed-form solution for polynomial regression
